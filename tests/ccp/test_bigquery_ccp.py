...
from apollo.integrations.ccp.defaults.bigquery import BIGQUERY_DEFAULT_CCP
...
def _resolve(credentials: dict) -> dict:
    return CcpPipeline().execute(BIGQUERY_DEFAULT_CCP, credentials)


class TestBigqueryCcp(TestCase):
    def test_not_registered(self):
        self.assertIsNone(CcpRegistry.get("bigquery"))
