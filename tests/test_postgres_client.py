...
class PostgresCcpPathTests(TestCase):
    ...
    def test_ccp_path_resolves_flat_credentials(self, mock_connect):
        """Flat credentials are resolved by CcpRegistry before reaching PostgresProxyClient."""
        mock_connect.return_value = self._mock_connection
        ...
        self._agent.execute_operation("postgres", "run_query", operation_dict, _POSTGRES_FLAT_CREDENTIALS)
