...
SQL_SERVER_DEFAULT_CCP = CcpConfig(
...
AZURE_SQL_DATABASE_DEFAULT_CCP = CcpConfig(
...
AZURE_DEDICATED_SQL_POOL_DEFAULT_CCP = CcpConfig(
...
# ODBC string (produced by the DC). CCP produces a dict of ODBC key-value pairs.
# Phase 2 will update the proxy clients to accept a dict and serialize it to a string,
# then these configs will be registered in CcpRegistry._discover().
